...
* [Заметки разработчика (Development Notes)](DEVELOPMENT_NOTES.md)
* [Руководство по развертыванию (Deploy)](DEPLOY.md)

### 🎥 Демонстрация работы

https://github.com/IlyaKarakcheev/CRMAgentForOutlook/raw/master/CRMAgentForOutlook.mp4

*(Если видео не загружается автоматически, вы можете [скачать его здесь](CRMAgentForOutlook.mp4))*
